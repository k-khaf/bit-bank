...
optimizeIndex <- function(index){
  ...
  return(list(optPort = port.opt3, optReabl = opt_rebal3, rets_df = rets_df3, tickers = SPYtickers))
  
}
  
#################################################################################################

optimizeTickers <- function(start,end,benchmark,index,tickers){
  ...
  return(list(optPort1 = port.opt3, optReabl1 = opt_rebal3, rets_df1 = rets_df3, tickers1 = tickers))
}
...
plotGrowth <- function(rets){
  chart.CumReturns(rets, main = "Portfolio Growth", wealth.index = TRUE, legend.loc="topleft")
}
...
plotReturns <- function(rets){
  chart.Bar(rets, main = "Portfolio Returns", legend.loc = "topright")
}
#################################################################################################
