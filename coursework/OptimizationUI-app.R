...
#opt.port <<- readRDS("C:/Users/kian/Desktop/R/Portfolio-optimization/data/general_optimization_optPort.RData")
#opt.port <- NULL
#opt.port1 <- NULL
...
ui <- fluidPage(
  ...
  helpText("Note: V1.0 of our portfolio optimization app currently supports a minimized standard deviation optimization method."),
  helpText("      To start a new optimization please click the refresh icon located in the top left of the page."),  
  sidebarLayout(
    ...
    mainPanel(
      ...
      fluidRow(
        ...
        conditionalPanel(
          ...
          titlePanel("General Optimization"),
          helpText("This version of the app doesn't optimize over the whole index - only 80 random assest within the S&P500"),
        ...
        conditionalPanel(
          ...
          helpText("The optimizations can take up to 10 minutes to compute depending on the number of assets."),
          helpText("Please meet the following criteria then hit the check button to enable the optimize button:"),
